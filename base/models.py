...
class ResturantBranch(BaseModel):
    ...
    resturant = models.ForeignKey(Resturant, on_delete=models.PROTECT, null=True, blank=True)
    is_active = models.BooleanField(default=False, blank=True)
    created_on = models.DateField(auto_now_add=True)
    main_domain = models.CharField(max_length=30, null=True)
    sub_domain = models.CharField(max_length=30, null=True)
...
class Account(AbstractBaseUser, PermissionsMixin):
    brnanch = models.ForeignKey(ResturantBranch, on_delete=models.PROTECT, null=True)
...
# def tanent_signal(sender, instance, created, **kwargs):
#     if created:
#         tanent = Resturant(schema_name="KFC", user=instance, name="KFC" ,is_active=True)
#         tanent.save()

#         domain_name = f"127.0.0.1"
#         domain = Domain()
#         domain.domain = domain_name
#         domain.tenant = tanent
